            ...
            <div class="row h-100 align-items-end">
                <div class="col-12">
                    <div class="breadcrumb-content d-flex align-items-center justify-content-between pb-5">
                        ...
                        <h2 class="room-price">$180 <span>/ Dia</span></h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-lg-8">
                    ...
                    <div class="single-room-details-area mb-50">
                        ...
                        <div class="room-features-area d-flex flex-wrap mb-50">
                            <h6>Tamanho: <span>350-425sqf</span></h6>
                    ...
                    <div class="room-service mb-50">
                        ...
                        <ul>
                            ...
                            <li><img src="img/core-img/icon2.png" alt=""> Bebidas grátis</li>
                            <li><img src="img/core-img/icon3.png" alt=""> Restaurantes pass</li>
                            <li><img src="img/core-img/icon4.png" alt=""> TV a cabo</li>
                            <li><img src="img/core-img/icon5.png" alt=""> Wifi ilimitado</li>
                            <li><img src="img/core-img/icon6.png" alt=""> Serviço de quarto 24h</li>
                        </ul>
                    </div>
                    ...
                    <div class="hotel-reservation--area mb-100">
                        <form action="#" method="post">
                            <div class="form-group mb-30">
                                <label for="checkInDate">Data</label>
                            ...
                            <div class="form-group mb-50">
                                <div class="slider-range">
                                    <div class="range-price">Preço: R$0 - R$3000</div>
                                    <div data-min="0" data-max="3000" data-unit="R$" class="slider-range-price ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" data-value-min="0" data-value-max="3000" data-label-result="Preço: ">
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn roberto-btn w-100">Verificar</button>
                            </div>
                        </form>
                    </div>
                </div>
